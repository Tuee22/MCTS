...
Phase `1` reopened again on 2026-06-04 for Sprint `1.17` after the generated
leaf-command docs still leaned on terse summaries, and the play command lacked
enough action-oriented command-use text around `BACKEND`, side ownership, and
AI-vs-AI spectating. Sprint `1.17` reclosed the same day with registry-backed
leaf descriptions, play parser help, generated command docs, README guidance, and
unit renderer/help assertions. The reopening did not change backend, transcript,
verification, or performance ownership.
