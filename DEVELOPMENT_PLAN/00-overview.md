...
`hostbootstrap run mcts <command>`. Sprint `9.3` closed the post-migration
report-card surface: `hostbootstrap run mcts test all` emits a non-pending
