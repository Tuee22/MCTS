...
renderPurpose path spec =
    case path of
        ...
        "mcts inspect" -> "Interactive cached-game browser for the local transcript cache"
        ...
        "mcts test all" -> "Plan/Apply: prebuilt Cabal stanzas, Dockerfile-built backends, and pinned report card"
